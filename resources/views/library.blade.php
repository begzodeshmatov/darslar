...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Kitoblar haqida</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/home">Asosiy</a></li>
                    <li class="breadcrumb-item active">Kitoblar haqida</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="exampleModalLabel">Kitoblar haqida qo'shish
                                            </h1>
                                            ...
                                            <form action="/kasbSave" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="name"
                                                        placeholder="F.I.O" required>
                                                </div>

                                                <div class="mb-3">
                                                    <label class="form-label">Stipendiya</label>
                                                    <input type="text" class="form-control" name="stipendiya"
                                                        placeholder="Stipendiya" required>
                                                </div>
                                                <!-- <div class="mb-3">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a data-bs-toggle="modal" class="btn btn-danger"
                                                    data-bs-target="#deleteKasb{{ $kasb->id }}" href="#"><i
                                                ...
                                                <div class="modal fade" id="exampleModal{{ $kasb->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="/kasbEditSave/{{ $kasb->id }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    <div class="mb-3">
                                                                        <label class="form-label">F.I.O</label>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            name="stipendiya"
                                                                            value="{{ $kasb->stipendiya }}">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Muddat</label>
                                                                        <input type="text" class="form-control"
                                                                            name="muddat" value="{{ $kasb->muddat }}">
                                                                    </div>
                                                ...
                                                <!-- Modal -->
                                                <div class="modal fade" id="deleteKasb{{ $kasb->id }}"
