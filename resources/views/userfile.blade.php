        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">UserFile</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card px-3 py-0">
                        <div class="card-body">
                            <h5 class="card-title">Amaliyot uchun </h5>
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <script>
                                        function submitForm() {
                                            ...
                                            if (select.value === 'excel') {
                                                form.action = ''; // excel export URL manzili
                                            } else if (select.value === 'pdf') {
                                                form.action = ''; // Pdf export URL manzili
                                            } else if (select.value === 'word') {
                                                form.action = ''; // Word export URL manzili
                                            }
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="exampleModalLabel">UserFile qo'shish</h1>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <form action="UserFileSave" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <fieldset>
                                                    <div class="mb-3">
                                                        <label for="disabledTextInput" class="form-label">Ismingizni
                                                            kiriting</label>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="disabledTextInput" class="form-label">Malumotnoma
                                                        </label>
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Malumotnoma</th>
                                    <th scope="col">Amallar</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($UserFile as $b)
                                    <tr>
                                        <th scope="row">{{ $b->id }}</th>
                                        <td>{{ $b->name }}</td>
                                        <td><a href="{{Storage::url($b->file)}}" target="_blank" {{ $b->file ?? 'File Yuklanmadi' }}></a></td>
                                        <td>
                                            <!-- Delete tugmasi -->
