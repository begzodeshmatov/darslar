...
<body>
    ...
    <div class="untree_co-hero overlay" style="background-image: url('template/images/hero-img-1-min.jpg');">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <a href="https://vimeo.com/342333493" data-fancybox class="video-wrap">
                        ...
                        <img src="template/images/img-school-4-min.jpg" alt="Image" class="img-fluid rounded">
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-stretch">
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="media-h d-flex h-100">
                        <figure>
                            <img src="template/images/img-school-1-min.jpg" alt="Image">
                        </figure>
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="media-h d-flex h-100">
                        <figure>
                            <img src="template/images/img-school-2-min.jpg" alt="Image">
                        </figure>
                        <div class="media-h-body">
                    ...
                    <div class="owl-carousel wide-slider-testimonial">
                        <div class="item">
                            <blockquote class="block-testimonial">
                                ...
                                <div class="author">
                                    <img src="template/images/person_1.jpg" alt="Free template by TemplateUX">
                                    <h3>John Doe</h3>
                        ...
                        <div class="item">
                            <blockquote class="block-testimonial">
                                ...
                                <div class="author">
                                    <img src="template/images/person_2.jpg" alt="Free template by TemplateUX">
                        ...
                        <div class="item">
                            <blockquote class="block-testimonial">
                                ...
                                <div class="author">
                                    <img src="template/images/person_3.jpg" alt="Free template by TemplateUX">
                                    <h3>Rob Smith</h3>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 mr-auto mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="0">
                    <img src="template/images/img-school-5-min.jpg" alt="image" class="img-fluid">
                </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                                ...
                                <div class="accordion-body">
                                    <div class="d-flex">
                                        <div class="accordion-img mr-4">
                                            <img src="template/images/img-school-3-min.jpg" alt="Image"
                                                class="img-fluid">
                                        </div>
                                        <div>
